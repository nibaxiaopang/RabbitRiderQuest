...
class RabbitRiderFeedBackVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        RabbitRiderKeyboardManager.shared.enable = true
    }
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        ...
        if isStarSelected {
            clearAllStars()
            RabbitRiderUtils.showAlert(title: "Thanks for feedback", message: "Your feedback added successfully", from: self)
        } else {
            RabbitRiderUtils.showAlert(title: "No Selection", message: "Please select a rating before submitting.", from: self)
        }
    }
